...
<div class="container-fluid">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                if($result->num_rows > 0){
                    while($row = $result->fetch_assoc()){
                        ...
                        echo "<td><a href='gestisci-responsabili.php?id=" . $row["IDUtente"] . "' class='btn btn-primary'>Gestisci</a></td>";
                        echo "</tr>";
                    }
                }else{
    ...
    <a class="btn btn-primary" href="gestisci-responsabili.php"><i class="fa-solid fa-plus"></i></a>
</div>
</body>
</html>
